...
const DIRECCION_CASA = "Pasaje 47 Casa 2156";
...
function actualizarCarrito() {
  ...
  const entrega = document.getElementById("entrega") ? document.getElementById("entrega").value : "Retiro en Casa";
...
function enviarPedido() {
  ...
  let direccion = (entrega === "Retiro en Casa") ? DIRECCION_TIENDA : direccionInput.value;
